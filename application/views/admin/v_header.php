<?php error_reporting(0); date_default_timezone_set("Asia/Jakarta"); define(NOW, date("H")); ?>
<!DOCTYPE html>
<html>
<body>
  <meta charset="utf-8">
...
<link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets/skin-admini.css">
<link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets/bootstrap/bootstrap.min.css">
<link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets/adminlte/AdminLTE.css">
<link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets/adminlte/dist/css/AdminLTE.min.css">
<link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets/adminlte/dist/css/skins/_all-skins.min.css">
<link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets/fontawesome/css/all.css">
<link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets/fontawesome/css/fontawesome.css">
...
<link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets/datatables/jquery.dataTables_themeroller.css">
